...
def main(args):
    ...
    wandb.init(project="llama2askdocs", entity="vijumuraari")
    ...
    #trainer = Trainer(model=model, args=training_arguments, train_dataset=train_dataset, eval_dataset=eval_dataset,callbacks=[EarlyStoppingCallback(early_stopping_patience=3, early_stopping_threshold=0.001)])
    #no callbadck below
